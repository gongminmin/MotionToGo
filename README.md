...
MotionToGo is a demonstration of adding motion blur to a video or image sequence. It uses GPU's motion estimator to estimate the motion vectors, then use a post process to apply the motion blur to the sequence.
